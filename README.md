...
This repo is a clone of https://github.com/zzh8829/yolov3-tf2 to which was added:

- [x] Flag for ignoring any detections which are not cars and convert truck detections to car detections.
